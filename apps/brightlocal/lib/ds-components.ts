...
export const PROPOSED_COMPONENTS: ProposedComponent[] = [
  ...
  { name: "SourceMark", module: "review-sources", summary: "The review source mark (Google, Facebook, TripAdvisor and the rest) with the capability model beside it: which review sites can be replied to and auto-replied to.", whenToUse: "Any list of reviews or review sites.", composes: "Icons (social family)" },
