...
const SECTION_CARDS: Record<string, Omit<CardSpec, "slug">> = {
  ...
  popovers: { kicker: "Every one of them", title: "Insights with additional data", line: "The eight dialogs, in order, with nothing else in the way.", surface: "var(--ds-tailwind-colors-violet-400)", ink: "black", art: ["idea", "tip"] },
  end: { kicker: "Reviews: Contextual Insights & Actions", title: "Insights exploration", line: "What could be possible with contextual AI insights", surface: "var(--ds-tailwind-colors-neutral-950)", ink: "white", art: ["help", "support"] },
};
