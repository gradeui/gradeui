...
const PERSONA_CARDS: Record<string, Omit<CardSpec, "slug">> = {
  ...
  multi: { kicker: "Three branches", title: "A multi-location brand", line: "Customers compare Hove with Brighton, and their reviews say so.", surface: "var(--ds-tailwind-colors-violet-400)", ink: "black", art: ["location", "local"] },
...
const SECTION_CARDS: Record<string, Omit<CardSpec, "slug">> = {
  beacon: { kicker: "Reviews", title: "Contextual Insights & Actions", line: "Like someone sat next to you, telling you what to do about your reviews.", surface: "var(--ds-tailwind-colors-neutral-950)", ink: "white", art: ["review", "stars"] },
  ...
  walkthrough: { kicker: "One location, one month", title: "Insights, page by page", line: "Minus 1 Studios, eight months in. The same numbers on every screen.", surface: "var(--ds-tailwind-colors-green-500)", ink: "black", art: ["review", "stars"] },
  popovers: { kicker: "Every one of them", title: "What it says when you ask", line: "The eight dialogs, in order, with nothing else in the way.", surface: "var(--ds-tailwind-colors-violet-400)", ink: "black", art: ["idea", "tip"] },
  end: { kicker: "Reviews: Contextual Insights & Actions", title: "Someone sat next to you", line: "Telling you what to do about your reviews, in your own numbers.", surface: "var(--ds-tailwind-colors-neutral-950)", ink: "white", art: ["help", "support"] },
};
