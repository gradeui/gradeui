...
export const config = {
  ...
  matcher: [
    ...
    "/((?!api|_next|_vercel|.*\\..*|docs|components|templates|blocks|brand|changelog|roadmap|play|chat|studio|layout-preview|skills|media|v2|sign-in|auth|accept-invite|terms|privacy).*)",
    // Always run for root
    "/",
