...
export const config = {
  ...
  matcher: [
    ...
    "/((?!api|_next|_vercel|.*\\..*|docs|components|templates|blocks|brand|variables|changelog|roadmap|blog|embed-tests|play|chat|studio|layout-preview|skills|media|sign-in|auth|accept-invite|terms|privacy|waitlist).*)",
    // Always run for root
    "/",
