...
// Type: the subsection heading (16/24 semibold) and body (16/24) as plain
// classes; the app spells them text-heading-subsection and text-body.
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      <p className="text-base leading-6 font-semibold" data-hook={`${dataHook}-title`}>
        {title}
      </p>
      {description ? (
        <p className="text-base leading-6 text-muted-foreground max-w-[52ch] text-pretty" data-hook={`${dataHook}-description`}>
          {description}
        </p>
      ) : null}
