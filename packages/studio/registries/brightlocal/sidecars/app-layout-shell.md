...
props:
  ...
  - pageLayers? (default | raised) — CARD treatment (tweaker: Page → Cards): re-points the canvas + card tokens on the layout root. "raised" = subtlest green-grey canvas (neutral-50), WHITE elevated cards, muted up to neutral-100. Presets in PAGE_LAYERS — tweak in code. (default "raised")
