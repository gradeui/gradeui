...
props:
  ...
  - sidebarTone? (default | white | subtle | dark | brand) — Re-skin the sidebar by re-pointing the --sidebar-* CSS variables on its container. Pure token swap; component internals untouched. (default "default")
  ...
  - pageLayers? (default | tinted) — Page-wide layer treatment: re-points the canvas + card tokens on the layout root. "tinted" = subtlest green-grey canvas (neutral-100), WHITE cards, muted drops to neutral-50. Presets in PAGE_LAYERS — tweak in code. (default "default")
