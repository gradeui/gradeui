...
props:
  ...
  dataHook: "string — hook for the header; title and description derive `${dataHook}-title` / `-description`."
  ...
  className: "string — appended to the DrawerHeader; use for the one local nuance a screen needs, such as `py-2!` under a bottom sheet's handle."
when_to_use: >
...
aliases: [drawer header, sheet title, panel header, close button header]
