...
const SECTIONS = [
  ...
  },
  {
    ...
    sub: [
      ...
      { id: "rankings-table", label: "Rankings Table", active: true },
  ...
  },
  {
    ...
    icon: Grid3x3,
    sub: [
      { id: "local-search-grid-keyword-1", label: "Keyword phrase #1" },
      { id: "local-search-grid-keyword-2", label: "Keyword phrase #2" },
      { id: "local-search-grid-keyword-3", label: "Keyword phrase #3" },
      { id: "local-search-grid-keyword-4", label: "Keyword phrase #4" },
      { id: "local-search-grid-keyword-5", label: "Keyword phrase #5" },
