        ...
        <SidebarMenu>
          <SidebarMenuItem>
            {/* `email` renders as span CHILDREN in the dist, so it
                takes an entity — the plan/trial Chip rides there.
                Upstream ask: rename to a typed `meta` ReactNode slot. */}
            <SidebarAccountDropdown
              dataHook="sidebar-account-dropdown"
              name="Joe Bloggs"
              email={<Chip className="mt-0.5">Trial — 14 days left</Chip>}
              avatar={
        ...
        <GlobalLayoutContentBody dataHook="page-body">
          <Card variant="filled" className="max-w-none" dataHook="content-placeholder">
            <CardContent>
              ...
              <div className="bg-muted h-[1600px] rounded-lg" />
            </CardContent>
          </Card>
        </GlobalLayoutContentBody>
      </AppLayoutShell>
